...
if (IN_GIT_REPO)
    set(OPENVDB_PATCH_COMMAND ${PATCH_CMD} ${OPENVDB_DIRECTORY_FLAG} ${CMAKE_CURRENT_LIST_DIR}/0001-clang19.patch)
else ()
    set(OPENVDB_PATCH_COMMAND git init && ${PATCH_CMD} ${CMAKE_CURRENT_LIST_DIR}/0001-clang19.patch)
endif ()
...
orcaslicer_add_cmake_project(OpenVDB
    ...
    PATCH_COMMAND ${OPENVDB_PATCH_COMMAND}
