...
if (IN_GIT_REPO)
    set(GMP_PATCH_COMMAND ${PATCH_CMD} ${GMP_DIRECTORY_FLAG} ${CMAKE_CURRENT_LIST_DIR}/0001-GMP_GCC15.patch)
else ()
    set(GMP_PATCH_COMMAND git init && ${PATCH_CMD} ${CMAKE_CURRENT_LIST_DIR}/0001-GMP_GCC15.patch)
endif ()
...
if (MSVC)
    ...
    ExternalProject_Add(dep_GMP
        ...
        PATCH_COMMAND ${GMP_PATCH_COMMAND}
        BUILD_IN_SOURCE ON
